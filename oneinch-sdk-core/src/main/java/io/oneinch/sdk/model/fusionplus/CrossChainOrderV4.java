...
/**
 * Cross-chain order structure for FusionPlus v4.
 * Enhanced version of the order structure supporting cross-chain operations.
 */
@Data
@Builder
@NoArgsConstructor
...
public class CrossChainOrderV4 {
    ...
    /**
     * Address that will receive the filled order (can be different from maker)
     */
