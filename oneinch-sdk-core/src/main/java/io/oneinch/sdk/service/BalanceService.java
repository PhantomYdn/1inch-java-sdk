...
public interface BalanceService {
     ...
     */
    Map<String, String> getBalances(BalanceRequest request) throws OneInchException;
     ...
     */
    CompletableFuture<Map<String, String>> getBalancesAsync(BalanceRequest request);
     ...
     */
    Single<Map<String, String>> getBalancesRx(BalanceRequest request);
     ...
     * @throws OneInchException if the request fails
     */
    Map<String, String> getCustomBalances(CustomBalanceRequest request) throws OneInchException;
     ...
     * @return CompletableFuture with map of token address to balance amount
     */
    CompletableFuture<Map<String, String>> getCustomBalancesAsync(CustomBalanceRequest request);
     ...
     * @return Single with map of token address to balance amount
     */
    Single<Map<String, String>> getCustomBalancesRx(CustomBalanceRequest request);
     ...
     * @throws OneInchException if the request fails
     */
    Map<String, String> getAllowances(AllowanceBalanceRequest request) throws OneInchException;
     ...
     */
    CompletableFuture<Map<String, String>> getAllowancesAsync(AllowanceBalanceRequest request);
     ...
     */
    Single<Map<String, String>> getAllowancesRx(AllowanceBalanceRequest request);
     ...
     * @throws OneInchException if the request fails
     */
    Map<String, String> getCustomAllowances(CustomAllowanceBalanceRequest request) throws OneInchException;
     ...
     * @return CompletableFuture with map of token address to allowance amount
     */
    CompletableFuture<Map<String, String>> getCustomAllowancesAsync(CustomAllowanceBalanceRequest request);
     ...
     * @return Single with map of token address to allowance amount
     */
    Single<Map<String, String>> getCustomAllowancesRx(CustomAllowanceBalanceRequest request);
     ...
     * @throws OneInchException if the request fails
     */
    Map<String, Map<String, String>> getBalancesByMultipleWallets(MultiWalletBalanceRequest request) throws OneInchException;
     ...
     */
    CompletableFuture<Map<String, Map<String, String>>> getBalancesByMultipleWalletsAsync(MultiWalletBalanceRequest request);
     ...
     */
    Single<Map<String, Map<String, String>>> getBalancesByMultipleWalletsRx(MultiWalletBalanceRequest request);
}